...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1430259940').split()] # Replace with the actual admin ID(s) to add
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/DG_Movies_Corner")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/DG_Movies_Corner")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/DG_Movies_Corner")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/DG_Movies_Corner') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/DG_Movies_Corner') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/DG_Movies_Corner') # Update channel link for the bot
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '192.168.1.1'))
